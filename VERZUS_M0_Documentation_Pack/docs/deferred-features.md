...
- security and fraud risks are understood;
- the verification path is defined;
- the feature has measurable user demand;
- its introduction does not create a single point of failure.
