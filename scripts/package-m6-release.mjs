// VERZUS M6.7 IMMUTABLE ARTIFACT PACKAGER
...
const outputDir = path.join(root, "artifacts/m6-competitions", release);
fs.mkdirSync(outputDir, { recursive: true });

const archive = path.join(outputDir, `verzus-m6-competitions-${release}.tar.gz`);
...
const manifest = {
  marker: "VERZUS M6.7 IMMUTABLE RELEASE",
  stage: "6.7",
  release,
  sourceCommit: commit,
  buildId,
...
console.log(`M6 immutable artifact: ${archive}`);
